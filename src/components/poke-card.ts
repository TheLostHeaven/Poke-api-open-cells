...
export class PokeCard extends LitElement {
  ...
  render() {
    return html`
      <div class="card work">
        ...
        <div class="card-title">Pokemon</div>
        <div class="card-menu">
        <div class="dot"></div>
        <div class="dot"></div>
          <div class="dot"></div>
        ...
        <div class="card-time">${this.pokemon? this.pokemon.name : ''}</div>
        </div></div>
    `;
  }
  ...
  //           <p class="card__title">${this.pokemon.name}</p>
  //           <p class="card__description">
  //             HP: ${this.pokemon.hp}, Attack: ${this.pokemon.attack}, Defense: ${this.pokemon.defense}
  //           </p>
  //         </div>
  //       ` : ''}
  //     </div>
